  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        <Button onClick={this.handleClickLoading} className={classes.button} style={{outline:'none'}}>
        ...
        <Button onClick={this.handleClickQuery} className={classes.button} style={{outline:'none'}}>
